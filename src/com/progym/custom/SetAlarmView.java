...
@EViewGroup ( R.layout.dialog_alarm ) public class SetAlarmView extends ScrollView {
     ...
     @AfterViews void afterViews() {
          cb630.setChecked(appPreff.cb630().getOr(false));
          cb7.setChecked(appPreff.cb7().getOr(false));
          cb730.setChecked(appPreff.cb730().getOr(false));
          cb8.setChecked(appPreff.cb8().getOr(false));
          cb830.setChecked(appPreff.cb830().getOr(false));
          cb9.setChecked(appPreff.cb9().getOr(false));
          cb930.setChecked(appPreff.cb930().getOr(false));
          cb10.setChecked(appPreff.cb10().getOr(false));
          cb1030.setChecked(appPreff.cb1030().getOr(false));
          cb11.setChecked(appPreff.cb11().getOr(false));
          cb1130.setChecked(appPreff.cb1130().getOr(false));
          cb12.setChecked(appPreff.cb12().getOr(false));
          cb1230.setChecked(appPreff.cb1230().getOr(false));
          cb13.setChecked(appPreff.cb13().getOr(false));
          cb1330.setChecked(appPreff.cb1330().getOr(false));
          cb14.setChecked(appPreff.cb14().getOr(false));
          cb1430.setChecked(appPreff.cb1430().getOr(false));
          cb15.setChecked(appPreff.cb15().getOr(false));
          cb1530.setChecked(appPreff.cb1530().getOr(false));
          cb16.setChecked(appPreff.cb16().getOr(false));
          cb1630.setChecked(appPreff.cb1630().getOr(false));
          cb17.setChecked(appPreff.cb17().getOr(false));
          cb1730.setChecked(appPreff.cb1730().getOr(false));
          cb18.setChecked(appPreff.cb18().getOr(false));
          cb1830.setChecked(appPreff.cb1830().getOr(false));
          cb19.setChecked(appPreff.cb19().getOr(false));
          cb1930.setChecked(appPreff.cb1930().getOr(false));
          cb20.setChecked(appPreff.cb20().getOr(false));
          cb2030.setChecked(appPreff.cb2030().getOr(false));
          cb21.setChecked(appPreff.cb21().getOr(false));
          cb2130.setChecked(appPreff.cb2130().getOr(false));
          cb22.setChecked(appPreff.cb22().getOr(false));
          cb2230.setChecked(appPreff.cb2230().getOr(false));
          cb23.setChecked(appPreff.cb23().getOr(false));
          cb2330.setChecked(appPreff.cb2330().getOr(false));;
     }

     @CheckedChange void cb630(CompoundButton cb, boolean isChecked) {
          appPreff.cb630().put(isChecked);
     }

     @CheckedChange void cb7(CompoundButton cb, boolean isChecked) {
          appPreff.cb7().put(isChecked);
     }

     @CheckedChange void cb730(CompoundButton cb, boolean isChecked) {
          appPreff.cb730().put(isChecked);
     }

     @CheckedChange void cb8(CompoundButton cb, boolean isChecked) {
          appPreff.cb8().put(isChecked);
     }

     @CheckedChange void cb830(CompoundButton cb, boolean isChecked) {
          appPreff.cb830().put(isChecked);
     }

     @CheckedChange void cb9(CompoundButton cb, boolean isChecked) {
          appPreff.cb9().put(isChecked);
     }

     @CheckedChange void cb930(CompoundButton cb, boolean isChecked) {
          appPreff.cb930().put(isChecked);
     }

     @CheckedChange void cb10(CompoundButton cb, boolean isChecked) {
          appPreff.cb10().put(isChecked);
     }

     @CheckedChange void cb1030(CompoundButton cb, boolean isChecked) {
          appPreff.cb1030().put(isChecked);
     }

     @CheckedChange void cb11(CompoundButton cb, boolean isChecked) {
          appPreff.cb11().put(isChecked);
     }

     @CheckedChange void cb1130(CompoundButton cb, boolean isChecked) {
          appPreff.cb1130().put(isChecked);
     }

     @CheckedChange void cb12(CompoundButton cb, boolean isChecked) {
          appPreff.cb12().put(isChecked);
     }

     @CheckedChange void cb1230(CompoundButton cb, boolean isChecked) {
          appPreff.cb1230().put(isChecked);
     }

     @CheckedChange void cb13(CompoundButton cb, boolean isChecked) {
          appPreff.cb13().put(isChecked);
     }

     @CheckedChange void cb1330(CompoundButton cb, boolean isChecked) {
          appPreff.cb1330().put(isChecked);
     }

     @CheckedChange void cb14(CompoundButton cb, boolean isChecked) {
          appPreff.cb14().put(isChecked);
     }

     @CheckedChange void cb1430(CompoundButton cb, boolean isChecked) {
          appPreff.cb1430().put(isChecked);
     }

     @CheckedChange void cb15(CompoundButton cb, boolean isChecked) {
          appPreff.cb15().put(isChecked);
     }

     @CheckedChange void cb1530(CompoundButton cb, boolean isChecked) {
          appPreff.cb1530().put(isChecked);
     }

     @CheckedChange void cb16(CompoundButton cb, boolean isChecked) {
          appPreff.cb16().put(isChecked);
     }

     @CheckedChange void cb1630(CompoundButton cb, boolean isChecked) {
          appPreff.cb1630().put(isChecked);
     }

     @CheckedChange void cb17(CompoundButton cb, boolean isChecked) {
          appPreff.cb17().put(isChecked);
     }

     @CheckedChange void cb1730(CompoundButton cb, boolean isChecked) {
          appPreff.cb1730().put(isChecked);
     }

     @CheckedChange void cb18(CompoundButton cb, boolean isChecked) {
          appPreff.cb18().put(isChecked);
     }

     @CheckedChange void cb1830(CompoundButton cb, boolean isChecked) {
          appPreff.cb1830().put(isChecked);
     }

     @CheckedChange void cb19(CompoundButton cb, boolean isChecked) {
          appPreff.cb19().put(isChecked);
     }

     @CheckedChange void cb1930(CompoundButton cb, boolean isChecked) {
          appPreff.cb1930().put(isChecked);
     }

     @CheckedChange void cb20(CompoundButton cb, boolean isChecked) {
          appPreff.cb20().put(isChecked);
     }

     @CheckedChange void cb2030(CompoundButton cb, boolean isChecked) {
          appPreff.cb2030().put(isChecked);
     }

     @CheckedChange void cb21(CompoundButton cb, boolean isChecked) {
          appPreff.cb21().put(isChecked);
     }

     @CheckedChange void cb2130(CompoundButton cb, boolean isChecked) {
          appPreff.cb2130().put(isChecked);
     }

     @CheckedChange void cb22(CompoundButton cb, boolean isChecked) {
          appPreff.cb22().put(isChecked);
     }

     @CheckedChange void cb2230(CompoundButton cb, boolean isChecked) {
          appPreff.cb2230().put(isChecked);
     }

     @CheckedChange void cb23(CompoundButton cb, boolean isChecked) {
          appPreff.cb23().put(isChecked);
     }

     @CheckedChange void cb2330(CompoundButton cb, boolean isChecked) {
          appPreff.cb2330().put(isChecked);
     }
