...
@EFragment ( R.layout.fragment_linegraph_yearly ) public class FoodProgressYearlyLineFragment extends Fragment {
     ...
     public void setLineData3(Date date) {
          ...
          XYSeries consumedSeries = new XYSeries("Protein");
          ...
          // should be same
          multiRenderer.setChartTitle(String.format("Protein/Carbs/Fat statistic for %s year", Utils.formatDate(DATE, DataBaseUtils.DATE_PATTERN_YYYY)));
