...
@EActivity ( R.layout.activity_food_managment ) public class ActivityFoodManagment extends ProgymSuperActivity {
     ...
     @Override @AfterViews void afterViews() {
          // init player
          mediaPlayer = MediaPlayer.create(ActivityFoodManagment.this, R.raw.food);
               ...
               @Override public boolean onDrag(View v, DragEvent event) {
                    switch (event.getAction()) {
                         case DragEvent.ACTION_DROP:
                              ...
                              view.twProductDescription.setText(String.format("%s : %.2fg (%skkal)", ingridient.name, ingridient.weight, ingridient.kkal));
               ...
               new Thread(new Runnable() {
                    @Override public void run() {
                         try {
                              ...
                              Utils.showCustomToast(ActivityFoodManagment.this, R.string.list_of_products_has_been_saved, R.drawable.ready);
                         } catch (Exception e) {
                              e.printStackTrace();
                         }
                         ringProgressDialog.dismiss();
