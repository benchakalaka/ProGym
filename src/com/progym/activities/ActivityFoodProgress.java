...
@EActivity ( R.layout.food_progress_activity ) public class ActivityFoodProgress extends ActivityAbstractProgress implements IProgressActivity {
     ...
     @Click void twDaily() {
          ...
          if ( null != meals && !meals.isEmpty() ) {
               ...
               Utils.showToast(ActivityFoodProgress.this, "There is no data to display", true);
          }
     }
     ...
     @Override public void updateFragment(int fragmentType) {
          ...
          switch (fragmentType) {
               ...
               case MONTHLY:
                    ...
                    ((ProgressViewPagerAdapter) viewPager.getAdapter()).linegraphMonthly.setLineData3(SELECTED_DATE);
                    break;
               case YEARLY:
