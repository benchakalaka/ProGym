...
public class WaterManagementActivity extends ProgymSuperActivity {
	...
	@Click void twCurrentDate() {
		...
		for ( WaterConsumed singleDate : list ) {
			try {
				...
				datesAndColour.put(DateUtils.parseDate(singleDate.date, GlobalConstants.DATE_PATTERN_YYYY_MM_DD_HH_MM_SS), consumedPerDay < 2000 ? R.color.caldroid_lighter_gray : com.caldroid.R.color.caldroid_sky_blue);
