...
public final class ActivityBMIResult_
    extends ActivityBMIResult
    implements HasViews, OnViewChangedListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_bmi_result);
    }
    ...
    public static ActivityBMIResult_.IntentBuilder_ intent(Context context) {
        return new ActivityBMIResult_.IntentBuilder_(context);
    }

    public static ActivityBMIResult_.IntentBuilder_ intent(android.app.Fragment fragment) {
        return new ActivityBMIResult_.IntentBuilder_(fragment);
    }

    public static ActivityBMIResult_.IntentBuilder_ intent(android.support.v4.app.Fragment supportFragment) {
        return new ActivityBMIResult_.IntentBuilder_(supportFragment);
    }
    ...
    public static class IntentBuilder_ {
        ...
        public IntentBuilder_(Context context) {
            context_ = context;
            intent_ = new Intent(context, ActivityBMIResult_.class);
        }

        public IntentBuilder_(android.app.Fragment fragment) {
            fragment_ = fragment;
            context_ = fragment.getActivity();
            intent_ = new Intent(context_, ActivityBMIResult_.class);
        }
        ...
        public ActivityBMIResult_.IntentBuilder_ flags(int flags) {
