...
public final class ActivityAdviceLevel_1_
    extends ActivityAdviceLevel_1
    implements HasViews, OnViewChangedListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_advice_level_1);
    }
    ...
    public static ActivityAdviceLevel_1_.IntentBuilder_ intent(Context context) {
        return new ActivityAdviceLevel_1_.IntentBuilder_(context);
    }

    public static ActivityAdviceLevel_1_.IntentBuilder_ intent(android.app.Fragment fragment) {
        return new ActivityAdviceLevel_1_.IntentBuilder_(fragment);
    }

    public static ActivityAdviceLevel_1_.IntentBuilder_ intent(android.support.v4.app.Fragment supportFragment) {
        return new ActivityAdviceLevel_1_.IntentBuilder_(supportFragment);
    }
    ...
    public void onViewChanged(HasViews hasViews) {
        ...
        {
            View view = hasViews.findViewById(id.ivFatBurinig);
            if (view!= null) {
                view.setOnTouchListener(new OnTouchListener() {
    ...
    public static class IntentBuilder_ {
        ...
        public IntentBuilder_(Context context) {
            context_ = context;
            intent_ = new Intent(context, ActivityAdviceLevel_1_.class);
        }

        public IntentBuilder_(android.app.Fragment fragment) {
            fragment_ = fragment;
            context_ = fragment.getActivity();
            intent_ = new Intent(context_, ActivityAdviceLevel_1_.class);
        }
        ...
        public ActivityAdviceLevel_1_.IntentBuilder_ flags(int flags) {
